...
PROJECT_NAME = "OpenPartecipate" or PACKAGE_NAME
PROJECT_PACKAGE = "open_partecipate" or PACKAGE_NAME
...
# See: https://docs.djangoproject.com/en/dev/ref/settings/#use-etags
USE_ETAGS = True
...
SECRET_KEY = r"a-ykc2j7760qacx9#er!mv7bi0ts*xaww1!9qem0j^cv(zyfx0"
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': normpath(join(RESOURCES_PATH, 'logs', 'open_partecipate.log')),
